    ...
    <body>
        ...
        <div class="space">
            ...
            <c:if test="${not empty sessionScope.cart}">
            	...
            	<div class="row">
			       	<div class="col-12 col-sm-12 col-md-2 text-center">
                    	<a href="ProductController?id=${cart.id}"><img class="img-fluid img-thumbnail float-left" src="${cart.img}" alt="prewiew" width="100" height="100"></a>
                    </div>
                    <div class="col-12 text-sm-center col-sm-12 text-md-left col-md-6">
                       	<a href="ProductController?id=${cart.id}"><h4 class="product-name"><strong>${cart.name}</strong></h4></a>
                    </div>
                        <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                            <div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 5px">
                                <h4><strong><fmt:formatNumber type = "number" maxIntegerDigits = "5" value = "${cart.price}" /><span class="text-muted"> RON</span></strong></h4>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="quantity">
